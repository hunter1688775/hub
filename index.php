...
<style>
    ...
    .card, .navbar, .footer-copyright {
        background-color: #1a1a1a; /* สีเทาเข้มสำหรับองค์ประกอบต่างๆ */
        color: #fff;
    }
    a {
        color: #ffcc00; /* สีลิงก์ */
    }
    a:hover {
        color: #ffffff; /* สีลิงก์เมื่อชี้เมาส์ */
    }
</style>
...
<body>
    ...
    <small class="pb-3 d-block my-auto footer-copyright text-secondary text-center py-4 w-100">
        ...
        <a href="https://lin.ee/Wy5SyDu" target="_blank">HUNTER168</a>
        All Rights Reserved.
    </small>
</body>
</html> 
